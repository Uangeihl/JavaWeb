    ...
    <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="user" items="${userList }" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a href="${pageContext.request.contextPath }/user/view/${user.id}"><img
                            src="${pageContext.request.contextPath }/static/images/read.png" alt="查看"
                            title="查看"/></a></span>
                    <span><a href="${pageContext.request.contextPath }/user/tomodify?id=${user.id}"> <img
                            src="${pageContext.request.contextPath }/static/images/xiugai.png" alt="修改" title="修改"/></a></span>
                    <span><a
                            href="javascript:if(confirm('确实要删除该用户吗?'))location='${pageContext.request.contextPath }/user/delete?id=${user.id}'"><img
